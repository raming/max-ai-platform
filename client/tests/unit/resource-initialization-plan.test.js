...
exports.ResourceInitializationPlanZodSchema = void 0;
...
exports.ResourceInitializationPlanZodSchema = ResourceInitializationPlanZodSchema;
describe('ResourceInitializationPlan JSON Schema Validation', () => {
    ...
    describe('Security Validation Tests', () => {
        test('Schema should allow credentials but QA must verify they are not exposed in API responses', () => {
            ...
            console.warn('SECURITY NOTE: This schema allows credentials but they must be ' +
...
//# sourceMappingURL=resource-initialization-plan.test.js.map