...
import { Environment, FeatureFlagStatus } from '../../src/domain/feature-flag';
import { generateTestUuid } from '../utils/test-uuid';

// E2E Test Configuration
const E2E_CONFIG = {
  // Test identifiers
  TEST_TENANT_ID: generateTestUuid(),
  TEST_USER_ID: generateTestUuid(),
    ...
    test('Bulk flag evaluation with multiple flags', async () => {
      ...
      expect(response.body).toMatchObject({
        results: expect.arrayContaining(
          E2E_CONFIG.BOOTSTRAP_FLAGS.map(flagName => 
