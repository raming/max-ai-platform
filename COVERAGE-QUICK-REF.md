...
| `COVERAGE-TIERS.md` | Comprehensive guide (read this first!) |
...
A: Move your package to Tier 2 (85-90%) with justification, or add more tests. See `COVERAGE-TIERS.md` for migration steps.
...
1. **Read full guide:** `COVERAGE-TIERS.md`
...
**Questions?** See `COVERAGE-TIERS.md` or open an issue.
