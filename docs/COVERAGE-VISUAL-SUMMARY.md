...
PROJECT ROOT
│
├── .coverage-tiers.json ..................... Tier registry (config)
├── /docs/
│   ├── COVERAGE-TIERS.md ................... Complete operational guide
│   ├── COVERAGE-QUICK-REF.md .............. Quick lookup (5 min)
│   └── COVERAGE-VISUAL-SUMMARY.md ......... Visual guide (this file)
│
├── .ops/
│   ├── tracker/agents/qa.mina-li/
│   │   ├── COVERAGE-IMPLEMENTATION.md .... QA test tracking
│   │   └── COVERAGE-TEST-REPORT.md ....... QA findings
│   │
│   └── workflows/
│       └── DEPLOYMENT-GUIDE.md ........... CI/CD rollout plan
│
...
```
1. READ
   Open: /docs/COVERAGE-QUICK-REF.md (5 minutes)
...
**Questions?** → Read `/docs/COVERAGE-QUICK-REF.md`  
**Need details?** → Read `/docs/COVERAGE-TIERS.md`  
**Implementing?** → See `.ops/workflows/DEPLOYMENT-GUIDE.md`
